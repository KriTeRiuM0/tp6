...
@Tag(name = "Student Controller", description = "API pour la gestion des étudiants")
public class StudentController {

    @Autowired
    private StudentService studentService;

    @Operation(summary = "Créer un nouvel étudiant", description = "Enregistre un nouvel étudiant dans la base de données")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Supprimer un étudiant", description = "Supprime un étudiant de la base de données par son identifiant")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Récupérer tous les étudiants", description = "Retourne la liste complète de tous les étudiants enregistrés")
